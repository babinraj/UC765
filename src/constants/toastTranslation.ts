export const translation: any = {
    en: {
		...
		DefaultAreaWarning: "Please note only one default area can be set per centrale",
        CbspartnerCreate: "CBS partner created successfully!",
        CbspartnerUpdate: "CBS partner updated successfully!",
        CbspartnerDelete: "CBS partner Deleted successfully!",
    ...
    nl: {
		...
		DefaultAreaWarning: "Let op: er kan slechts één standaardgebied per centrale worden ingeste",
        ...
        CbspartnerDelete: "CBS-partner Succesvol verwijderd!",
